...
/**
 * Unit tests for the gradereport_submission implementation of the privacy API.
 *
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences_single() {
        ...
        $this->setUser($user);
        set_user_preference('gradereport_submission_view_user', 1, $user);
        ...
        $prefs = $writer->get_user_preferences('gradereport_submission');
        $this->assertCount(1, (array) $prefs);
        $this->assertEquals(
            get_string('privacy:metadata:preference:gradereport_submission_view_user', 'gradereport_submission'),
            $prefs->gradereport_submission_view_user->description
        );
        $this->assertEquals(get_string('yes'), $prefs->gradereport_submission_view_user->value);
    }
}
