...
/**
 * Tests for gradereport_submission library functions.
 *
...
/**
 * Class gradereport_submission_lib_testcase.
 *
 * @package   gradereport_submission
 * @author    Tomo Tsuyuki <tomotsuyuki@catalyst-au.net>
 * @copyright Catalyst IT
...
class lib_test extends \advanced_testcase {
    ...
    public function test_gradereport_submission_myprofile_navigation() {
        ...
        gradereport_submission_myprofile_navigation($this->tree, $this->user, $iscurrentuser, $this->course);
