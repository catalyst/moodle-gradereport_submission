 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gradereport_submission_external extends external_api {
    ...
    protected static function get_report_data($course, $context, $user, $userid, $groupid, $tabledata = true) {
        ...
        // Just one user.
        if ($user) {
            $report = new grade_report_submission($course->id, $gpr, $context, $userid);
            $report->fill_table();
            ...
            while ($userdata = $gui->next_user()) {
                ...
                $report = new grade_report_submission($course->id, $gpr, $context, $currentuser->id);
                $report->fill_table();
    ...
    public static function view_grade_report($courseid, $userid = 0) {
        ...
        $report = new grade_report_submission($course->id, null, $context, $userid);
        $report->viewed();
