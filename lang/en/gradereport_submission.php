...
/**
 * Strings for component 'gradereport_submission', language 'en'
 *
...
$string['showattemptnumber'] = 'Show attempt number';
$string['showattemptnumber_help'] = 'Whether to show attempt number for assignment activity.';
$string['showsubmissionstatus'] = 'Show submission status';
$string['showsubmissionstatus_help'] = 'Whether to show submission status.';
$string['showgradingstatus'] = 'Show grading status';
$string['showgradingstatus_help'] = 'Whether to show grading status.';
$string['showdateofgrading'] = 'Show date of grading';
